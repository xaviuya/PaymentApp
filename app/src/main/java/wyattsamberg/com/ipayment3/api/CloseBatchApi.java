...
public class CloseBatchApi extends AsyncTask<String, String, String> {
    public static final String TAG = CloseBatchApi.class.getSimpleName();

    private HttpURLConnection mUrlConnection;
    private NetworkCallListener mNetworkCallListener;

    public CloseBatchApi(NetworkCallListener networkCallListener) {
    ...
    protected String doInBackground(String... params) {
        String url = NetworkUrl.BASE_URL + "/closeBatch";
